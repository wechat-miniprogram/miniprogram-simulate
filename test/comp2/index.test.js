...
function runTest(id) {
  ...
  expect(window.getComputedStyle(comp.querySelector('.index').dom).width).toBe('10vw')
  ...
  expect(comp.querySelector('.other').instance.selectOwnerComponent()).toBe(comp.instance)
}
