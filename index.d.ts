...
export function load(componentPath: string, tagName: string, options?: LoadOptions): string

export function match(dom: Node, html: string): boolean;

export function sleep(timeout: number): Promise<void>;

export function scroll(component: Component<any, any, any>, destOffset: number, times?: number, propName?: string): void;
